...
public class CoreStepInsertSplinePathNatural2 : MonoBehaviour
{
    ...
    void Board(Vector3 worldStart, Vector3 worldDirection, bool slope, int scale)
    {
        ...
        {
            BoardPair[] stairway =
                TakeBoard(slope, LayerMask.NameToLayer("Slope"), $"StairWay{stairwayCount++}", scale);
            Debug.Log($"StairWay{stairwayCount} " + $"scale={scale}, " + $"start={localStart}, " +
