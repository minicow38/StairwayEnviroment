...
public sealed class SlopeStickBall7 : MonoBehaviour
{
    const string ImplementationVersion = "AdaptiveCriticalAdhesion-NaturalRelease-v8-AutoScaled32-2026-07-23";
   ...
   [SerializeField] float targetProgressMaximumArtificialAcceleration = 4f;
        ...
        float targetSpeed)
    {
        ...
        if (writeRuntimeLog && logAutomaticSpeedHomogeneousControl)
        {
            Debug.Log(
                ...
                $"controlDistance={controlDistance:F6} controlSeconds={capturedAutomaticControlSeconds:F6} " +
        ...
        float dt)
    {
        ...
        targetProgressGravityAcceleration = compensateTargetProgressGravity
            ? Vector3.Dot(Physics.gravity, travelTangent)
            : 0f;

        targetProgressDesiredArtificialAcceleration =
            targetProgressRequiredNetAcceleration - targetProgressGravityAcceleration;
        ...
        targetProgressDesiredArtificialAcceleration = Mathf.Clamp(
            targetProgressDesiredArtificialAcceleration,
        ...
        targetProgressAppliedArtificialAcceleration = Mathf.MoveTowards(
